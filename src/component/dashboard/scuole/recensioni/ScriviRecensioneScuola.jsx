...
function ScriviRecensioneScuola(props) {
  ...
  const handleSubmit = (e) => {
    ...
    if (recensione.voto && recensione.voto !== "" && recensione.voto > 0 && recensione.voto < 6) {
      fetch(
        props.mode === "new"
          ? apiUrl + "/recensioni-scuola/" + props.id
          : apiUrl + "/recensioni-scuola/" + props.recensione.id,
        {
...
export default ScriviRecensioneScuola;
