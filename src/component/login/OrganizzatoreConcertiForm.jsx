...
function OrganizzatoreConcertiForm() {
  ...
  return (
    <div>
      <h1 className="metal-mania-regular text-center">Registrati come Organizzatore di Eventi Musicali</h1>
      <Form className="my-3">
        ...
        <Form.Group controlId="formBasicRagioneSociale">
          ...
          <Form.Control type="text" placeholder="Inserisci il nome della tua azienda" />
        </Form.Group>
